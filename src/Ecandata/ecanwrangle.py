...
def clean_ecan(ecan_data):
    ...
    filter_p_use_df = ecan_data.loc[(ecan_data['Primary_Use'].isin(filter_by)) | (ecan_data['Secondary_Use'].isin(filter_by))] #We don't care about anything other than stuff people will drink
